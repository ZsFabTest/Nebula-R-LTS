...
public class NebulaPlugin : BasePlugin
{
    ...
    public static string PluginVisualVersion = (IsSnapshot ? "23.07.18-" : "") + PluginVersion;
    public static string PluginStage = IsSnapshot ? "Snapshot" : "";
    
    public const string PluginVersionForFetch = "1.0.3.2";
    public byte[] PluginVersionData = new byte[] { 1, 0, 3, 2 };
