...
public class NebulaPlugin : BasePlugin
{
    ...
    public const string PluginVersion = "1.0.3.5";
    public const bool IsSnapshot = true;

    public static string PluginVisualVersion = (IsSnapshot ? "23.08.11-" : "") + PluginVersion;
    public static string PluginStage = IsSnapshot ? "Snapshot" : "";
    
    public const string PluginVersionForFetch = "1.0.3.5";
    public byte[] PluginVersionData = new byte[] { 1, 0, 3, 5 };
