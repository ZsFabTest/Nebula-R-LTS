...
public class AirshipData : MapData
{
    ...
    public AirshipData() : base(4,"Airship")
    {
        ...
        RegisterObjectPosition(new Vector2(-8.8515f, 9.0895f), SystemTypes.VaultRoom, 40f);
        RegisterObjectPosition(new Vector2(1.3844f, 0.379f), SystemTypes.Engine, 40f, 1.2f);
        RegisterObjectPosition(new Vector2(-19.677f, -0.791f), SystemTypes.Cockpit, 30f, 1f);
        RegisterObjectPosition(new Vector2(-5.1793f, -8.5239f), SystemTypes.Kitchen, 35f);
        RegisterObjectPosition(new Vector2(18.315f, -3.8655f), SystemTypes.Electrical, 30f, 0.9f);
        RegisterObjectPosition(new Vector2(29.0523f, -7.461f), SystemTypes.Medical, 30f, 1.4f);
        RegisterObjectPosition(new Vector2(39.039f, 1.4811f), SystemTypes.CargoBay, 35f);
