...
public class BountyHunter : Template.HasHologram
{
    ...
    private Module.CustomOption canChangeTargetOption;
    private Module.CustomOption changeTargetCooldownOption;

    private SpriteLoader changeTargetButtonSprite = new SpriteLoader("Nebula.Resources.RepairButton.png", 115f);
    ...
    private static CustomButton changeTarget;
    ...
    public override void LoadOptionData()
    {
        ...
        killCoolDownMultiplierAfterKillingBountyOption = CreateOption(Color.white, "killCoolDownMultiplierAfterKillingBounty", 5f, 0f, 25f, 2.5f);
        killCoolDownMultiplierAfterKillingBountyOption.suffix = "second";
        killCoolDownMultiplierAfterKillingOthersOption = CreateOption(Color.white, "killCoolDownMultiplierAfterKillingOthers", 45f, 25f, 60f, 2.5f);
        killCoolDownMultiplierAfterKillingOthersOption.suffix = "second";
        ...
        canChangeTargetOption = CreateOption(Color.white, "canChangeTarget", true);
        changeTargetCooldownOption = CreateOption(Color.white, "changeTargetCoolDown", 30f, 10f, 60f, 10f).AddPrerequisite(canChangeTargetOption);
    ...
    public override void ButtonInitialize(HudManager __instance)
    {
        ...
        killButton = new CustomButton(
            () =>
            {
                ...
                killButton.Timer = (target.PlayerId == currentBounty) ? killCoolDownMultiplierAfterKillingBountyOption.getFloat() : killCoolDownMultiplierAfterKillingOthersOption.getFloat();
                ChangeBounty();
            },
        ...
        changeTarget = new CustomButton(
            () =>
            {
                ChangeBounty();
                changeTarget.Timer = changeTarget.MaxTimer;
            },
            () => { return !PlayerControl.LocalPlayer.Data.IsDead; },
            () => { return PlayerControl.LocalPlayer.CanMove; },
            () => { changeTarget.Timer = changeTarget.MaxTimer; },
            changeTargetButtonSprite.GetSprite(),
            Expansion.GridArrangeExpansion.GridArrangeParameter.None,
            __instance,
            Module.NebulaInputManager.abilityInput.keyCode,
            "button.label.change"
        ).SetTimer(CustomOptionHolder.InitialAbilityCoolDownOption.getFloat());
        changeTarget.MaxTimer = changeTargetCooldownOption.getFloat();
    }
