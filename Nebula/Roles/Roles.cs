...
static public class Roles
{
    ...
    public static GhostRoles.GameMaster GameMaster = new GhostRoles.GameMaster();
    ...
    public static CrewmateRoles.Paranoiac Paranoiac = new();
    ...
    public static CrewmateRoles.VentBomber VentBomber = new();
    ...
    public static CrewmateRoles.Philosopher Philosopher = new();
