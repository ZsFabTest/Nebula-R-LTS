...
static public class Roles
{
    ...
    public static FDecider F_Decider = new FDecider();
    public static Decider EvilDecider = new Decider("EvilDecider", "evilDecider", true);
    public static Decider NiceDecider = new Decider("NiceDecider", "niceDecider", false);
    public static CrewmateRoles.SecondaryBait SecondaryBait = new CrewmateRoles.SecondaryBait();
    public static Holmes Holmes = new Holmes();
    public static Kotwal Kotwal = new Kotwal();
    public static Necrophilic Necrophilic = new Necrophilic();
    public static Observer Observer = new Observer();
    public static OnlineCelebrity OnlineCelebrity = new OnlineCelebrity();
    public static Sanctifier Sanctifier = new Sanctifier();
    //public static CrewmateRoles.Transporter Transporter = new CrewmateRoles.Transporter();
    public static WhiteCat WhiteCat = new WhiteCat();
    public static Flash Flash = new Flash();
    public static Assassin Assassin = new Assassin();
    public static Demagogue Demagogue = new Demagogue();
    public static Escapist Escapist = new Escapist();
    public static EvilBusker EvilBusker = new EvilBusker();
    public static RedCat RedCat = new RedCat();
    public static SerialKiller SerialKiller = new SerialKiller();
    public static Vampire Vampire = new Vampire();
    public static BlueCat BlueCat = new BlueCat();
    public static Madman Madman = new Madman();
    public static SchrodingersCat SchrodingersCat = new SchrodingersCat();
    public static Pavlov Pavlov = new Pavlov();
    public static Dog Dog = new Dog();
    public static Dictator Dictator = new Dictator();
    public static JackalMayor JackalMayor = new JackalMayor();
    public static PavlovsCat PavlovsCat = new PavlovsCat();
    public static InvisibleMan InvisibleMan = new InvisibleMan();
    public static Moriarty Moriarty = new Moriarty();
    public static Moran Moran = new Moran();
    public static Cascrubinter Cascrubinter = new Cascrubinter();
    public static Heretic Heretic = new Heretic();
    public static Amnesiac Amnesiac = new Amnesiac();
    //public static CrewmateRoles.Bartender Bartender = new CrewmateRoles.Bartender();
    public static FSwapper F_Swapper = new FSwapper();
    public static Swapper EvilSwapper = new Swapper("EvilSwapper", "evilSwapper", true);
    public static Swapper NiceSwapper = new Swapper("NiceSwapper", "niceSwapper", false);
    public static SecondaryJackal SecondaryJackal = new SecondaryJackal();
    public static LuckyMan LuckyMan = new LuckyMan();
    public static Moda Moda = new Moda();
    public static GhostEngineer GhostEngineer = new GhostEngineer();
    public static Marksman Marksman = new Marksman();
    public static Gambler Gambler = new Gambler();
    public static Superstar Superstar = new Superstar();
    public static ChivalrousExpert ChivalrousExpert = new ChivalrousExpert();
    public static Programmer Programmer = new Programmer();
    public static Plumber Plumber = new Plumber();
    public static Minekeeper Minekeeper = new Minekeeper();
    public static ChainKiller ChainKiller = new ChainKiller();
    public static Terrorist Terrorist = new Terrorist();
    public static Dying Dying = new Dying();
    public static Locksmith Locksmith = new Locksmith();
    public static FakeLover FakeLover = new FakeLover();
    public static Cheater Cheater = new Cheater();
    public static FMover F_Mover = new FMover();
    public static Mover EvilMover = new Mover("EvilMover", "evilMover", true);
    public static Mover NiceMover = new Mover("NiceMover", "niceMover", false);
    public static FTransporter F_Transporter = new FTransporter();
    public static Transporter EvilTransporter = new Transporter("EvilTransporter", "evilTransporter", true);
    public static Transporter NiceTransporter = new Transporter("NiceTransporter", "niceTransporter", false);
    public static Retarder Retarder = new Retarder();
    public static Yandere Yandere = new Yandere();
    public static SecretCrush SecretCrush = new SecretCrush();
    public static Marker Marker = new Marker();
    public static DeputyMayor DeputyMayor = new DeputyMayor();
    //public static ExtraRoles.Signaller Signaller = new Signaller();
    public static Mercenary Mercenary = new Mercenary();
    public static Resurrectionist Resurrectionist = new Resurrectionist();
    public static Supporter Supporter = new Supporter();
    public static Werewolf Werewolf = new Werewolf();
    public static Challenger Challenger = new Challenger();
    public static Supportee Supportee = new Supportee();
    public static Oracle OracleN = new Oracle();
    public static WerewolfsCat WerewolfsCat = new WerewolfsCat();
    public static OraclesCat OraclesCat = new OraclesCat();
    //public static CrewmateRoles.Detective Detective = new CrewmateRoles.Detective();
    public static Singer Singer = new Singer();
    public static Hadar HadarS = new Hadar();
    public static Zombie Zombie = new Zombie();
    public static ZombieSidekick ZombieSidekick = new ZombieSidekick();
    public static TaoistPriest TaoistPriest = new TaoistPriest();
