...
static public class Roles
{
    ...
    public static GameMaster GameMaster = new AllSideRoles.GameMaster();
    public static FDecider F_Decider = new ComplexRoles.FDecider();
    public static Decider EvilDecider = new ComplexRoles.Decider("EvilDecider", "evilDecider", true);
    public static Decider NiceDecider = new ComplexRoles.Decider("NiceDecider", "niceDecider", false);
    public static CrewmateRoles.SecondaryBait SecondaryBait = new CrewmateRoles.SecondaryBait();
    public static Holmes Holmes = new CrewmateRoles.Holmes();
    public static Kotwal Kotwal = new CrewmateRoles.Kotwal();
    public static Necrophilic Necrophilic = new CrewmateRoles.Necrophilic();
    public static Observer Observer = new CrewmateRoles.Observer();
    public static OnlineCelebrity OnlineCelebrity = new ExtraRoles.OnlineCelebrity();
    public static Sanctifier Sanctifier = new CrewmateRoles.Sanctifier();
    //public static CrewmateRoles.Transporter Transporter = new CrewmateRoles.Transporter();
    public static WhiteCat WhiteCat = new CrewmateRoles.WhiteCat();
    public static Flash Flash = new ExtraRoles.Flash();
    public static Assassin Assassin = new ImpostorRoles.Assassin();
    public static Demagogue Demagogue = new ImpostorRoles.Demagogue();
    public static Escapist Escapist = new ImpostorRoles.Escapist();
    public static EvilBusker EvilBusker = new ImpostorRoles.EvilBusker();
    public static RedCat RedCat = new ImpostorRoles.RedCat();
    public static SerialKiller SerialKiller = new ImpostorRoles.SerialKiller();
    public static Vampire Vampire = new ImpostorRoles.Vampire();
    public static BlueCat BlueCat = new NeutralRoles.BlueCat();
    public static Madman Madman = new NeutralRoles.Madman();
    public static SchrodingersCat SchrodingersCat = new NeutralRoles.SchrodingersCat();
    public static Pavlov Pavlov = new NeutralRoles.Pavlov();
    public static Dog Dog = new NeutralRoles.Dog();
    public static Dictator Dictator = new CrewmateRoles.Dictator();
    public static JackalMayor JackalMayor = new NeutralRoles.JackalMayor();
    public static PavlovsCat PavlovsCat = new NeutralRoles.PavlovsCat();
    public static InvisibleMan InvisibleMan = new ImpostorRoles.InvisibleMan();
    public static Moriarty Moriarty = new NeutralRoles.Moriarty();
    public static Moran Moran = new NeutralRoles.Moran();
    public static Cascrubinter Cascrubinter = new NeutralRoles.Cascrubinter();
    public static Heretic Heretic = new ImpostorRoles.Heretic();
    public static Amnesiac Amnesiac = new NeutralRoles.Amnesiac();
    //public static CrewmateRoles.Bartender Bartender = new CrewmateRoles.Bartender();
    public static FSwapper F_Swapper = new ComplexRoles.FSwapper();
    public static Swapper EvilSwapper = new ComplexRoles.Swapper("EvilSwapper", "evilSwapper", true);
    public static Swapper NiceSwapper = new ComplexRoles.Swapper("NiceSwapper", "niceSwapper", false);
    public static SecondaryJackal SecondaryJackal = new ExtraRoles.SecondaryJackal();
    public static LuckyMan LuckyMan = new CrewmateRoles.LuckyMan();
    public static Moda Moda = new ImpostorRoles.Moda();
    public static GhostEngineer GhostEngineer = new GhostRoles.GhostEngineer();
    public static Marksman Marksman = new ImpostorRoles.Marksman();
    public static Gambler Gambler = new ImpostorRoles.Gambler();
    public static Superstar Superstar = new ExtraRoles.Superstar();
    public static ChivalrousExpert ChivalrousExpert = new CrewmateRoles.ChivalrousExpert();
    public static Programmer Programmer = new CrewmateRoles.Programmer();
    public static Plumber Plumber = new ImpostorRoles.Plumber();
    public static Minekeeper Minekeeper = new CrewmateRoles.Minekeeper();
    public static ChainKiller ChainKiller = new ImpostorRoles.ChainKiller();
    public static Terrorist Terrorist = new ImpostorRoles.Terrorist();
    public static Dying Dying = new ImpostorRoles.Dying();
    public static Locksmith Locksmith = new CrewmateRoles.Locksmith();
    public static FakeLover FakeLover = new ExtraRoles.FakeLover();
    public static Cheater Cheater = new ExtraRoles.Cheater();
    public static FMover F_Mover = new ComplexRoles.FMover();
    public static Mover EvilMover = new ComplexRoles.Mover("EvilMover", "evilMover", true);
    public static Mover NiceMover = new ComplexRoles.Mover("NiceMover", "niceMover", false);
    public static FTransporter F_Transporter = new ComplexRoles.FTransporter();
    public static Transporter EvilTransporter = new ComplexRoles.Transporter("EvilTransporter", "evilTransporter", true);
    public static Transporter NiceTransporter = new ComplexRoles.Transporter("NiceTransporter", "niceTransporter", false);
    public static Retarder Retarder = new ImpostorRoles.Retarder();
    public static Yandere Yandere = new NeutralRoles.Yandere();
    public static SecretCrush SecretCrush = new ExtraRoles.SecretCrush();
    public static Marker Marker = new ImpostorRoles.Marker();
    public static DeputyMayor DeputyMayor = new ExtraRoles.DeputyMayor();
    //public static ExtraRoles.Signaller Signaller = new ExtraRoles.Signaller();
    public static Mercenary Mercenary = new NeutralRoles.Mercenary();
    public static Resurrectionist Resurrectionist = new CrewmateRoles.Resurrectionist();
    public static Supporter Supporter = new CrewmateRoles.Supporter();
    public static Werewolf Werewolf = new NeutralRoles.Werewolf();
    public static Challenger Challenger = new NeutralRoles.Challenger();
    public static Supportee Supportee = new ExtraRoles.Supportee();
    public static Oracle OracleN = new NeutralRoles.Oracle();
    public static WerewolfsCat WerewolfsCat = new NeutralRoles.WerewolfsCat();
    public static OraclesCat OraclesCat = new NeutralRoles.OraclesCat();
    //public static CrewmateRoles.Detective Detective = new CrewmateRoles.Detective();
    public static Singer Singer = new ExtraRoles.Singer();
    public static Hadar HadarS = new ImpostorRoles.Hadar();
    public static Zombie Zombie = new ImpostorRoles.Zombie();
    public static ZombieSidekick ZombieSidekick = new CrewmateRoles.ZombieSidekick();
    public static TaoistPriest TaoistPriest = new CrewmateRoles.TaoistPriest();
    public static WiseMan WiseMan = new();
    public static Wanted Wanted = new();
    public static ExtremeRoles.Ghost Ghost = new();
    public static Paranoiac Paranoiac = new();
    public static BomberA BomberA = new();
    public static BomberB BomberB = new();
    public static Puppeteer Puppeteer = new();
    ...
    public static Officer Officer = new();
    public static Follower Follower = new();
    public static VirusCrisisRoles.Doctor DoctorV = new();
    public static HighRoller HighRoller = new();
    public static Challenged Challenged = new();
    public static ProfessionalAssassin ProfessionalAssassin = new();
    public static BattleRoles.GreenTeamCat GreenTeamCat = new();
    public static BattleRoles.YellowTeamCat YellowTeamCat = new();
    public static Grenadier Grenadier = new();
    public static Hitman Hitman = new();
    public static TimeManager TimeManager = new();
    public static Enchanter Enchanter = new();
    //public static CrewmateRoles.OppositeMan OppositeMan = new();
    public static Radar Radar = new();
    public static Extortionist Extortionist = new();
    public static EvilGhost EvilGhost = new();
    public static VentBomber VentBomber = new();
    ...
    public static SoulEater SoulEater = new();
    public static Deadbeat Deadbeat = new();
    public static Philosopher Philosopher = new();
    ...
    public static List<Role> AllRoles = new List<Role>()
        {
            ...
            Holmes,Kotwal,Necrophilic,Observer,/*OnlineCelebrity,*/Sanctifier,/*Transporter,*/Dictator,/*Bartender,*/LuckyMan,/*Superstar,*/ChivalrousExpert,Programmer,Minekeeper,Locksmith,Resurrectionist,Supporter,ZombieSidekick,TaoistPriest,WiseMan,Paranoiac,Officer,TimeManager,Enchanter/*,OppositeMan*/,VentBomber,Philosopher,
